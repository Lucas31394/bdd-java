...
//	}
	...
	@Dado("um lance no valor de {double} reais do usuario {string}")
	public void um_lance_no_valor_de_reais_do_usuario(Double valor, String nomeUsuario) {
	...
	@Dado("um lance no valor de {double} reais")
	public void dado_um_lance_invalido(Double valor) {
